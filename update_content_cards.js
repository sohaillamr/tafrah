  ...
  const labels =
    language === "ar"
      ? {
          ...
          valuesTitle: "التأثير والامتداد المتكامل",
          values: [
            "جسر تواصل: نربط بين وزارة التضامن الاجتماعي، ومراكز التأهيل، والشركات الكبرى.",
            "الدعم الإداري (بطاقة الخدمات المتكاملة): من خلال تنسيقنا مع وزارة التضامن الاجتماعي، نسهل مسار الحصول على الوثائق الرسمية. بمساندتنا لمجتمعنا في استخراج بطاقة الخدمات المتكاملة، نحوّل 'المواهب المحتملة' إلى 'محترفين مؤهلين قانونياً'.",
            "تمكين مهني لا شفقة: نركز على كفاءة الفرد وقدرته على تقديم قيمة حقيقية في سوق العمل.",
            "مسار حصة الـ 5%: نوفر قناة مباشرة لتساند المؤسسات في تفعيل حصص التوظيف القانونية بأفضل الكفاءات، خالية من أي عوائق إدارية."
          ],
      ...
      : {
          ...
          valuesTitle: "Impact & Full-Cycle Reach",
          values: [
            ...
            "Administrative Support Wing: Through our coordination with the Ministry of Social Solidarity, we streamline the path to official documentation. By helping our community secure their Integrated Service Cards, we turn 'potential talent' into 'legally eligible professionals'.",
...
fs.writeFileSync('app/page.tsx', homeContent, 'utf8');
fs.writeFileSync('app/about/page.tsx', aboutContent, 'utf8');
